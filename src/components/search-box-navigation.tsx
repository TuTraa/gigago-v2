  ...
  return (
    <div className='relative' onClick={onOpen}>
      ...
      <input
        ...
        className={`${isOpen ? 'w-[330px] p-[12px_45px_12px_45px]' : 'w-0 border-none outline-none p-[12px_10px_12px_45px]'} leading-[20px] text-[15px]  duration-500 outline-none border-[1px] border-gray-200 rounded-lg placeholder:text-black/80 placeholder:text-[14px] focus:outline focus:outline-gray-500 focus:outline-offset-0`}
      />
