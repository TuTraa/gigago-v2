...
const BigCountryCard = ({ singleCountry, className }: BigCountryCardProps) => {
  return (
    <Link
      ...
      className={cn(
        `w-full p-[24px] border-[1px] rounded-xl shadow-sm flex flex-col items-start outline-none outline-offset-0 hover:outline hover:outline-primary hover:outline-[2px]  transition-outline duration-300`,
        className,
      )}
    >
