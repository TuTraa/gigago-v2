      ...
      <div className='grid grid-cols-12 md:gap-x-[30px] md:gap-y-[30px]'>
        <div className='col-span-4 flex flex-col items-center px-[10px]'>
          <Image
            ...
            className='mb-[16px]'
          />
          <h4 className='mb-[8px] text-[20px] font-semibold'>Easy to use</h4>
        ...
        <div className='col-span-4 flex flex-col items-center px-[10px]'>
          <Image
            ...
            className='mb-[16px]'
          />
          <h4 className='mb-[8px] text-[20px] font-semibold'>
            Free roaming charge
          </h4>
          <p className='text-[16px] text-center'>
        ...
        <div className='col-span-4 flex flex-col items-center px-[10px]'>
          <Image
            ...
            className='mb-[16px]'
          />
          <h4 className='mb-[8px] text-[20px] font-semibold'>24/7 support</h4>
          <p className='text-[16px] text-center'>
